...
import { getBalance, getPost, testProvider, createReply } from "../utils/transition";



export default function App({ Component, pageProps }: AppProps) {

  const {_connectToMetaMask,_sendMessageToMetaMask,accountData,provider,signer}=useConnection();
